...
export default function Home() {
  return (
    <div className="min-h-screen">
      <section className="relative bg-gradient-to-r from-slate-800 via-slate-700 to-orange-600 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mb-8 text-gray-200">
              Conectando los 9 departamentos de Bolivia con seguridad, comodidad y puntualidad.
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-gray-600">Conductores certificados</p>
              </CardContent>
            </Card>
            <Card className="text-center">
              <CardContent className="pt-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
            {departamentos.map((depto) => (
              <Card key={depto.id} className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
                <div className="h-48 bg-cover bg-center" style={{ backgroundImage: `url(${depto.imagen})` }}>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Noticias Recientes</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {noticias.map((noticia) => (
              <Card key={noticia.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                <div className="h-40 bg-cover bg-center" style={{ backgroundImage: `url(${noticia.imagen})` }}></div>
                <CardHeader>
                  <CardTitle className="text-lg">{noticia.titulo}</CardTitle>
                  <CardDescription className="text-xs">{noticia.fecha}</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-600 line-clamp-3">{noticia.contenido}</p>
                </CardContent>
              </Card>
            ))}
          </div>
