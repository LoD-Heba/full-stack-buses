...
import { User, Phone, IdCard, MapPin, AlertCircle, Mail } from "lucide-react";
    ...
    <div className="max-w-3xl mx-auto mt-10 p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complete la información del cliente. Todos los campos son
            obligatorios para que el cliente pueda comprar tickets.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Input
                    ...
                    {...register("phone", {
                      ...
                      pattern: {
                        ...
                        message:
                          "Formato inválido. Ejemplos: +59170123456, 70123456",
                      },
                    })}
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    El email es opcional y se puede agregar más tarde
                  </p>
                </div>
