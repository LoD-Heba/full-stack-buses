...
export class AuthService {
  ...
  async login(loginDto: LoginDto): Promise<LoginResponse> {
    ...
    const user = await this.findUserForAuth(name);
  ...
  private generateAuthResponse(user: User): LoginResponse {
    ...
    const identifierType: 'email' | 'phone' = 'email';
  ...
  private async findUserForAuth(name: string): Promise<User | null> {
