...
export class CreateBusDto {
  ...
  @IsOptional()
  @IsInt({ message: 'El número de pisos debe ser un entero' })
  @Min(1, { message: 'Debe tener al menos 1 piso' })
  @Max(2, { message: 'No puede tener más de 2 pisos' })
  floors?: number;
  ...
  @IsEnum(BusStatus, {
    message:
      'El status debe ser: disponible, en_uso, mantenimiento o fuera_de_servicio',
  })
  status?: BusStatus;
